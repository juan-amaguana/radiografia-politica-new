...
class CreateJudicialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('judiciales', function (Blueprint $table) {
            ...
            $table->string('nombre_judicial');  
            $table->integer('numero_judicial');

            $table->unsignedBigInteger('tipo_jucio_id')->nullable();
            $table->foreign('tipo_jucio_id')->references('id')->on('tipo_jucios')->onDelete('SET NULL');
