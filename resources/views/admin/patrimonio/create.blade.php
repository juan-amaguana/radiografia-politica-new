...
@section('title', 'Crear Patrimonio')
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Ingresar Patrimonio</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ route('patrimonios.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="numero_casas" id="numero_casas" placeholder="Ingrese numero de casas" >
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="numero_carros" id="numero_carros" placeholder="Ingrese numero de carros" >
            ...
            <div class="row" style="display: none;">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="numero_companias" id="numero_companias" placeholder="Ingrese el numero de companias" >
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" step=any class="form-control" name="activos" id="activos" placeholder="Ingrese los activos de la persona. Ejm: 1995.95" required>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" step=any class="form-control" name="pasivos" id="pasivos" placeholder="Ingrese pasivos de la persona. Ejm: 1995.95" required>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <label>Fecha de declaracion patrimonios actual <span class="text-red">*</span></label>

                  <div class="input-group date">
                    <div class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                    </div>
                    <input type="text" class="form-control pull-right" name="fecha_declaracion"  id="datepicker" required>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="nombre_archivo_patrimonio1">Archivo de patrimonio actual <span class="text-aqua">(.pdf)</span> <span class="text-red">*</span></label>
                  <input type="file" name="nombre_archivo_patrimonio1" class="dropify" data-allowed-file-extensions="pdf" data-max-file-size="2M"  required />
