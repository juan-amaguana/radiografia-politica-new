...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <ol class="breadcrumb">
      <li><a href="/posiciones"><i class="fa fa-dashboard"></i> Lista posiciones</a></li>
      <li class="active"> <a href="/posiciones/create">Editar Posición</a> </li>
    </ol>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Editar Posición</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{route('posiciones.update',$posicion)}}" method="POST">
            @method('PUT')
            @csrf
            <div class="box-body">
              <div class="form-group">
                <label for="nombre_posicion">Nombre posición <span class="text-red">*</span></label>
                <input type="text" class="form-control" name="nombre_posicion" id="nombre_posicion" placeholder="Ingrese el nombre de la posición" required value="{{$posicion->nombre_posicion}}">
              ...
              <input type="hidden" id="edit-value-Funcion-estado" value="{{$posicion->funcion_estado}}">

              <input type="hidden" id="edit-categoria-posicion" value="{{$posicion->categoria_id}}">
              
              <div class="form-group">
                <label for="categoria_posicion_funcion">La posición pertenece a <span class="text-red">*</span></label>
                <div class="form-group">
                  <label>
                    <input type="radio" value="1" onclick="mostrarFuncionesEstado();"  name="categoria_posicion_funcion" class="flat-red" required {{ ( $posicion->funcion_estado->categoria == 0 ) ? 'checked' : '' }}>
                    Funcion del estado
                  </label> <br>
                  <label>
                    <input type="radio" value="2" onclick="mostrarInstitucionesIndependientes();" name="categoria_posicion_funcion" class="flat-red" {{ ( $posicion->funcion_estado->categoria == 1 ) ? 'checked' : '' }}>
                    Instituciónes independientes
                  </label><br>
                  <label>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <br>
                  <label>
                    <input type="radio" value="3" onclick="ocultarTodo();" name="categoria_posicion_funcion" class="flat-red" checked="">
                    Ninguna
                  </label>
                </div>
...
<script src="{{asset('/js/posicion/edit_categoria_funcion.js')}}"></script>
