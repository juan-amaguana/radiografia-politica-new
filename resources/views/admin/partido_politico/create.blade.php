...
@section('content')
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"> <a href="/partidosPoliticos/create">Crear partido politico</a> </li>
    </ol>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Ingresar partido político </h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form action="{{ route('partidosPoliticos.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nombre_partido_politico" id="nombre_partido_politico" placeholder="Ingrese el nombre del partido político" required>
              ...
              <div class="form-group">
                <label for="nombre">Imagen del partido político <span class="text-aqua">(90x90)</span> <span class="text-red">*</span></label>
                <input type="file" name="imagen_partido_politico" class="dropify" data-allowed-file-extensions="png jpg gif jpeg" data-max-file-size="2M" required />
