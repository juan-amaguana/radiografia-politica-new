...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <ol class="breadcrumb">
      <li><a href="/actividades"><i class="fa fa-dashboard"></i> Lista Actividad </a></li>
      <li class="active"> <a href="/actividades/create">Crear Actividad </a> </li>
    </ol>
  </ol>
</section>
        ...
        <form action="{{ route('actividades.update',$actividad) }}" method="POST">
          ...
          <div class="box-body">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="persona_id" style="width: 100%;" required>
                    ...
                    <option value="{{$persona->id}}" {{ ( $persona->id == $actividad->persona_id ) ? 'selected' : '' }}>{{$persona->nombres_persona}} {{$persona->apellidos_persona}}</option>
                    @endforeach
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre_fuente_actividad" value="{{$actividad->nombre_fuente_actividad}}" id="nombre_fuente_actividad" placeholder="Ingrese la fuente de la actividad " required>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="url" class="form-control" name="link_fuente_actividad" value="{{$actividad->link_fuente_actividad}}" id="link_fuente_actividad" placeholder="Ingrese la url de la actividad " required>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>
                      <input type="radio" value="1" onclick="posicionActual();" name="posicion_actual" class="flat-red" required {{ ( $actividad->posicion_actual == 1 ) ? 'checked' : '' }} >
                      Si
                    </label> <br>
                    <label>
                      <input type="radio" value="0" onclick="posicionNoActual();" name="posicion_actual" class="flat-red" {{ ( $actividad->posicion_actual == 0 ) ? 'checked' : '' }}>
                      No
                    </label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="posicion_id" id="posicion-id" style="width: 100%;" required>
                    <option value="">Selecciones una opcion</option>
                    @foreach($posiciones as $posicion)
                    <option value="{{$posicion->id}}" {{ ( $posicion->id == $actividad->posicion_id ) ? 'selected' : '' }}>{{$posicion->nombre_posicion}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" name="fecha_inicio_actividad" value="{{$actividad->fecha_inicio_actividad}}" placeholder="fecha inicio de la actividad " id="datepicker" required>
              ...
              <div class="col-lg-6">
                <div class="form-group" id="fecha-fin-actividad" style="display: none;">
                  ...
                  <div class="input-group date">
                    ...
                    @if(!is_null($actividad->fecha_fin_actividad))
                    <input type="text" class="form-control pull-right" name="fecha_fin_actividad" value="{{$actividad->fecha_fin_actividad}}" placeholder="fecha fin de la actividad " id="datepicker1" required>
                    @else
            ...
            <div class="row" id="" style="">
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="url_legislativo">URI legislativo <span class="text-red"></span></label>
                  <input type="url" class="form-control pull-right" name="url_legislativo" id="url_legislativo" placeholder="URI de la gestión como asambleista" id="datepicker"  value="{{$actividad->url_legislativo}}">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="partido_politico_id">Partido Político</label>
                  <select class="form-control select2" name="partido_politico_id" style="width: 100%;" >
                    <option value="">Selecciones una opcion</option>
                    @foreach($partidos_politicos as $partido_politico)
                    <option value="{{$partido_politico->id}}" {{ ( $partido_politico->id == $actividad->partido_politico_id ) ? 'selected' : '' }}>{{$partido_politico->nombre_partido_politico}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="tipo_actividad_id" style="width: 100%;" required>
                    ...
                    <option value="{{$tipo_actividad->id}}" {{ ( $tipo_actividad->id == $actividad->tipo_actividad_id ) ? 'selected' : '' }}>{{$tipo_actividad->nombre_tipo_actividad}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-6" style="display: none;">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="sector_id"  style="width: 100%;" >
                    ...
                    <option value="{{$sector->id}}" {{ ( $sector->id == $actividad->sector_id ) ? 'selected' : '' }}>{{$sector->nombre}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="provincia_id" id="select-provincia" onchange="getSelectValueProvincia()" style="width: 100%;" >
                    ...
                    <option value="{{$provincia->id}}" {{ ( $provincia->id == $actividad->provincia_id ) ? 'selected' : '' }}>{{$provincia->nombre}}</option>
                    @endforeach
                  </select>
            ...
            <input type="text" hidden id="edit_canton_id" value="{{$actividad->canton_id}}">
            ...
            <div class="row" style="display: none;">
              ...
              <input type="text" hidden id="edit_parroquia_id" value="{{$actividad->parroquia_id}}">
              <!-- /.col-lg-6 -->
              <div class="col-lg-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="descripcion_corta" name="descripcion_corta" id="" cols="30" rows="5" required>{{$actividad->descripcion_corta}}</textarea>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="descripcion" name="descripcion" id="" cols="30" rows="5" >{{$actividad->descripcion}}</textarea>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="importante">Es importante la  activada</label>
                  <div class="form-group">
                    <label>
                      <input type="radio" value="1" name="importante" class="flat-red"  {{ ( $actividad->importante == 1 ) ? 'checked' : '' }}>
                      Si
                    </label> <br>
                    <label>
                      <input type="radio" value="0" name="importante" class="flat-red" {{ ( $actividad->importante == 0 ) ? 'checked' : '' }}>
                      No
                    </label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>
                      <input type="radio" value="1" name="es_encargo_puesto" class="flat-red" {{ ( !is_null($actividad->es_encargo_puesto) && $actividad->es_encargo_puesto == 1 ) ? 'checked' : '' }}>
                      Si
                    </label> <br>
                    <label>
                      <input type="radio" value="0" name="es_encargo_puesto" class="flat-red" {{ ( !is_null($actividad->es_encargo_puesto) && $actividad->es_encargo_puesto == 0 ) ? 'checked' : '' }}>
                      No
                    </label>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>
                      <input type="radio" value="1" name="es_subrogacion_puesto" class="flat-red"  {{ ( !is_null($actividad->es_subrogacion_puesto) && $actividad->es_subrogacion_puesto == 1 ) ? 'checked' : '' }}>
                      Si
                    </label> <br>
                    <label>
                      <input type="radio" value="0" name="es_subrogacion_puesto" class="flat-red" {{ ( !is_null($actividad->es_subrogacion_puesto) && $actividad->es_subrogacion_puesto == 0 ) ? 'checked' : '' }}>
                      No
                    </label>
...
<script src="{{asset('/js/selects_provincia/edit_carga_seletcs_provincia.js')}}"></script>
<script src="{{asset('/js/posicion/uri_gestion_asambleista.js')}}"></script>
<script src="{{asset('/js/posicion/uri_gestion_asambleista_edit.js')}}"></script>
<script src="{{asset('/js/actividad/fecha_fin.js')}}"></script>
<script src="{{asset('/js/actividad/fecha_fin_edit.js')}}"></script>
