...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <ol class="breadcrumb">
      <li><a href="/penales"><i class="fa fa-dashboard"></i> Lista Penal</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Editar Penal</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ route('penales.update',$penal) }}" method="POST">
          @method('PUT')
          @csrf
          <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="perfil_id" style="width: 100%;" required>
                    ...
                    <option value="{{$perfil->id}}" {{ ( $perfil->id == $penal->perfil_id ) ? 'selected' : '' }}>{{$perfil->persona->nombres_persona}} {{$perfil->persona->apellidos_persona}}</option>
                    @endif
                    @endforeach
                  </select>
               ...
               <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="tipo_jucio_id" style="width: 100%;" required>
                    ...
                    <option value="{{$tipo_jucial->id}}" {{ ( $tipo_jucial->id == $penal->tipo_jucio_id ) ? 'selected' : '' }}>{{$tipo_jucial->nombre_tipo_juicio}}</option>
                    @endforeach
                  </select>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre_penal" value="{{$penal->nombre_penal}}" id="nombre_penal" placeholder="Ingrese al nombre penal" required>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="total_penal">Numero Penal</label>
                  <input type="number" class="form-control" name="total_penal" value="{{$penal->total_penal}}" id="total_penal" placeholder="Ingrese el numero penal" required>
