...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <ol class="breadcrumb">
      <li><a href="/admin/companias"><i class="fa fa-dashboard"></i> Lista companias</a></li>
      <li class="active"> <a href="/companias/create">Crear compania</a> </li>
    </ol>
  </ol>
</section>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Ingresar Compania</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nombre_compania" id="nombre_compania" placeholder="Ingrese nombres de la compania" required>
            ...
            <div class="row">
              ...
              <div class="col-lg-6" style="display: none;">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="total_compania" id="total_compania" placeholder="Ingrese el total de la compania" >
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="posicion" id="posicion" min="0" placeholder="Ingrese la posición" required>
