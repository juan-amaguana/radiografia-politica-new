...
<div class="container white container-search-box" id="fcd-rp-search" :action="'{{ url('/') }}'">

  <div class="section">

    <form action="#" method="post" @submit.prevent="onSubmit" :action="this.action">
      ...
      <div class="row">
        ...
        <div class="col s12 m12 l3">
            ...
            <ul id="opciones-filtrado" class="sidenav collapsible expandable remove_border">
            ...
            <ul id='dropdown1' class='dropdown-content'>
              ...
              <!-- <li>
                <div class="collapsible-header">Institución<i class="caret material-icons">keyboard_arrow_down</i></div>
                <div class="collapsible-body">
                  <p><label><input type="checkbox" class="filled-in"/><span>Presidencia</span></label></p>
                  <p><label><input type="checkbox" class="filled-in"/><span>CCPS</span></label></p>
                  <span class="blue-text text-darken-1 text-view-more">+ Ver más</span>
                </div>
              </li> -->
              <li class="ub-pl-20 ub-pr-20">
              ...
              <li class="ub-pl-20 ub-pr-20">
                <div class="collapsible-header">Estado<i class="caret material-icons">keyboard_arrow_down</i></div>
                <div class="collapsible-body">
                  ...
                  <p><label><input type="checkbox" class="filled-in" v-on:change="show_data()" :value="2" v-model="checkedEstadoPolitico" /><span>Ex Funcionario</span></label></p>
        ...
        <div class="col s12 m12 l9 search-box">
          ...
          <div class="row">
            ...
            <div class="input-field col m2 l2 xl2 ub-custom-height-3 valign-wrapper center-align ub-ocultar-mobile">
              <a class='dropdown-trigger btn-small right ub-custom-search-order blue' data-target='dropdown2'>Ordenar</a>
              <ul id='dropdown2' class='dropdown-content'>
                <li><a @click="search_order = 'asc'; show_data()">Ascendentemente</a></li>
                <li><a @click="search_order = 'desc'; show_data()">Descendentemente</a></li>
                  ...
                  <div class="col s6 m4 l4 xl3 animated zoomIn fast" v-for="perfil in display_records">
                    <div class="card sticky-action" style="overflow: visible;">
                      ...
                      <div class="card-action">
                        <a :href="'/perfil/' + perfil.id" class="btn-profile">&nbsp;&nbsp;Ver perfil</a>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="section" style="margin-left:-5%;margin-left: -5.5%; background: #004a6c;width: 109.5%;">
    <div class="row">

      <div class="container light slogan">
        <div class="textwidget custom-html-widget">
          <h1 style="color: #fff">Perfiles más visitados</h1>
          <h2 style="color: #fff">Mira los perfiles más visitados del portal</h2>
        </div>
        <br />
      </div>

      <div class="imagen-perfil-circle col s4 m3 l2 center-align" v-for="perfil in perfiles.slice(0, 6)" v-if="perfil.img !== null">
        <a :href="'/perfil/' + perfil.id"><img :src="perfil.picture" :alt="perfil.twitter" class="circle responsive-img hoverable amber ub-padding-2" width="80%"></a>
