...
<div class="row section grey lighten-3">
  <div class="container">
    <div class="col 11 m10 offset-m1 l9 "><h5 class="flow-text">Funcionarios por género</h5></div>
  </div>
</div>
...
<div id="fcd-rp-page" class="container">
  <div class="row">
    ...
    <div class="col s12 m12 l9">
      <p>Conoce cuántos hombres y cuántas mujeres son funcionarios de alto rango.</p>
      ...
      <div class="fcd-button-footer-props fcd-btn-vermas hide-on-small-only">
        <a href="/excel-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>Excel</a>
        <a href="/csv-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>CSV</a>
        <a href="/api/json-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>JSON</a>
      </div>

      <div class="fcd-button-footer-props fcd-btn-vermas hide-on-med-and-up">
        <div class="row">
          <div class="col s4" style="margin-top: 10px"><a href="/excel-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>Excel</a></div>
          <div class="col s4" style="margin-top: 10px"><a href="/api/json-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>JSON</a></div>
          <div class="col s4" style="margin-top: 10px"><a href="/csv-genero" target="_blank" class="waves-effect waves-light btn"><i class="material-icons right">arrow_downward</i>CSV</a></div>
        </div>
      </div>
      <!-- fin botones API -->
      <div class="row">
        <div class="col s12 m4 l6"><div class="map-chart"  id="chartdiv"></div></div>
        <div class="col s12 m8 l3"><div id="legenddiv-genero" style="height: 400px"></div></div>
      </div>
...
<script src="/js/graficas_radiografia_politica/nuevas_graficas/graficas_genero.js"></script>
