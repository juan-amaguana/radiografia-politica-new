...
<div class="row section grey lighten-3">
    <div class="container">
    <div class="col 11 m10 offset-m1 l9 "><h5 class="flow-text">Funcionarios de alto rango clasificados según su área de estudio</h5></div>
    </div>
</div>
...
<div id="fcd-rp-page" class="container">
  <div class="row">
      ...
      <div class="col s12 m12 l9">
        <p>En esta gráfica encontrarás a los funcionarios clasificados según su área de estudio. Las áreas de estudio presentadas corresponden a la clasificación realizada por UNESCO y utilizada por SENESCYT.</p>
      ...
      <!-- fin botones API -->
        <div class="row">
          ...
          <div class="col s12 m8 l6"><div id="legenddiv" style="height: 400px"></div></div>
        </div>
...
<script src="/js/graficas_radiografia_politica/nuevas_graficas/graficas_profesiones_area.js"></script>
