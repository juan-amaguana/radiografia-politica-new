...
@section('head')
<style>
  .map-chart, #legenddiv-patrimonio {
  width: 100%;
  height: 400px;
  margin: 1em 0;
}
...
<div class="row section grey lighten-3">
  <div class="container">
    <div class="col 11 m10 offset-m1 l9 "><h5 class="flow-text">Funcionarios de alto rango clasificados por el monto de su declaración patrimonial.</h5></div>
  </div>    
</div>
...
<div id="fcd-rp-page" class="container">
  <div class="row">
    ...
    <div class="col s12 m12 l9">
      <p>En esta gráfica encontrarás a los funcionarios de alto rango clasificados según el monto de su declaración patrimonial.</p>
      ...
      <div class="row">
        ...
        <div class="col s12 m8 l6"><div id="legenddiv-patrimonio" style="height: 400px"></div></div>
      </div>
...
<script src="/js/graficas_radiografia_politica/nuevas_graficas/graficas_patrimonio_rango_funcion_estado2.js"></script>
